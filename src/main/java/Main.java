...
public class Main {
    ...
    public static void main(String args[]) {
        ...
        Module m5 = new Module("Math", "E861", List.of(s6, s7, s8, s9, s10));
        ...
        List<CourseProgramme> courses = List.of(cp1, cp2);
        ...
        System.out.println("\n\nCOURSES: \n" );
        courses.stream().forEach(course -> System.out.println(
                "Name: " + course.getName() +
                "\nModules: " + course.getModules().stream().map(Module::getName).collect(Collectors.toList()) +
        ...
        System.out.println("\n\nMODULES: \n" );
        modules.stream().forEach(module -> System.out.println(
                "Name: " + module.getName() +
                "\nID: " + module.getID() +
                "\nStudents Enrolled: " + module.getStudentsEnrolled().stream().map(Student::getName).collect(Collectors.toList()) +
                "\n"));
